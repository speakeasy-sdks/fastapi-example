# FastAPI Clerk Auth Example

A demonstration of using Clerk JWT authentication with FastAPI. This example shows how to integrate Clerk's user authentication with a FastAPI backend API.
